...
#define BOARD_NAME        "Seeed Studio XIAO ESP32-S3"
#define BOARD_DESCRIPTION "Seeed Studio XIAO ESP32-S3 with external I2S DAC"
...
// Control GPIOs (optional on XIAO carrier boards)
